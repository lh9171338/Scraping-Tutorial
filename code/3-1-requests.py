...
def post_name():
    ...
    data = {"firstname": "333", "lastname": "456"}
...
def post_image():
    ...
    file = {'uploadFile': open('../image/image1.png', 'rb')}
...
def post_login():
    ...
    r = requests.post('https://pythonscraping.com/pages/cookies/welcome.php', data=payload)
